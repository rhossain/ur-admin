...
(function ($) {
    ...
    BootstrapTable.LOCALES['en-US'] = BootstrapTable.LOCALES.en = {
        formatLoadingMessage: function () {
            ...
            return '<i class="fa fa-spinner" aria-hidden="true"></i> Loading table, please wait...';
        },
        formatRecordsPerPage: function (pageNumber) {
            // return sprintf('%s rows per page', pageNumber);
            return sprintf('Showing %s rows', pageNumber);
        },
        formatRecordsPerPageTotal: function (totalRows) {
            return sprintf(' of <strong>%s</strong>', totalRows);
        },
    ...
    BootstrapTable.prototype.initPagination = function () {
        ...
        if (!this.options.onlyInfoPagination) {
            ...
            html.push(this.options.formatRecordsPerPage(pageNumber.join('')), this.options.formatRecordsPerPageTotal(this.options.totalRows));
            html.push('</span>');
